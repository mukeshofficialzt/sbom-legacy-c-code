...
int main() {
    ...
    printf("Legacy C Code Example\n");

    // Example of a mathematical function from math.h
    double number = 16.0;
    double square_root = sqrt(number);
    printf("Square root of %.2f is %.2f\n", number, square_root);

    // Example of using OpenSSL (third-party library)
    unsigned char digest[SHA256_DIGEST_LENGTH];
    const char *data = "CycloneDX SBOM example";
